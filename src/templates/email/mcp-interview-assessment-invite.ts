...
export interface McpInterviewAssessmentInviteEmailData
...
/**
 * MCP Interview Assessment Invite email template.
 *
 * Identical content/layout to the generic Job AI Assessment interview
 * link template, but kept separate so the MCP flow can be customized later.
 */
export class McpInterviewAssessmentInviteEmailTemplate extends BaseEmailTemplate {
  protected getSubject(): string {
    const { jobTitle, companyName } = this
      .data as McpInterviewAssessmentInviteEmailData;
    return `Your AI Assessment Link: ${jobTitle} at ${companyName}`;
  }

  protected getTemplate(): string {
    const { candidateName, companyName, jobTitle, invitationUrl } = this
      .data as McpInterviewAssessmentInviteEmailData;
      ...
      <tr>
        <td align="center" style="padding: 32px 24px;" class="content-padding">
          ...
          ${this.createStatusContainer(
            '✅',
            'Assessment Ready',
            `Hi ${candidateName}, we're excited to invite you to complete your AI-powered assessment for the ${jobTitle} position at ${companyName}. Your assessment link is ready and you can start at your convenience.`,
            'success'
          )}
          ...
          ${this.createInfoCard(
            'Assessment Details',
            `<strong>Type:</strong> AI Interview Assessment<br><strong>Focus:</strong> Communication, problem-solving, and role fit<br><strong>How it works:</strong> Answer a short series of AI-generated questions using your browser (video and/or text).`,
            'highlight'
          )}
...
Assessment Details:
• Type: AI Interview Assessment
• Focus: Communication, problem-solving, and role fit
• How it works: Answer a short series of AI-generated questions using your browser (video and/or text).
